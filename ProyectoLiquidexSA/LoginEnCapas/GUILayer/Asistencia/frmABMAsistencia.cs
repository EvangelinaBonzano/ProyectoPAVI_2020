...
namespace ProyectoLiquidexSA.GUILayer.Asistencia
{
    public partial class frmABMAsistencia : Form
    {
        ...
        private void MostrarDatos()
        {
            ...
            {
                txtNombre.Text = oAsistenciaUsuariosSelected.Usuario.NombreUsuario;
                ...
                case FormMode.insert:
                    {
                        if (ExisteAsistencia() == false)
                        {
                            if (ValidarCampos())
                            {
                                ...
                                oAsistenciaUsuarios.Usuario.NombreUsuario = txtNombre.Text;
                ...
                case FormMode.update:
                    {
                        if (ValidarCampos())
                        {
                            ...
                            oAsistenciaUsuariosSelected.Usuario.IdUsuario = Convert.ToInt32(txtNombre.Text);
        ...
        {
            return oAsistenciaService.ObtenerAsistencia(txtNombre.Text) != null;
        }
